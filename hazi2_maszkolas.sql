...
NEV varchar(64) Masked with (Function ='partial(2,"xxx", 0)'),
SZULEV int Masked with (function='random(1800,2100)'),
NEM varchar(1) Masked with (function='default()'),
CIM varchar(128) Masked with (FUNCTION = 'partial(4,"xxx", 0)')
)
