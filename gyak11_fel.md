...
```js
select title from movies_and_tv 
where type=' Movies' and  release_year = 2018 // csak olyan ami kulcs, ha nem kulcsra akarunk, először ki kell szűrni sorokat ;  az and et ismeri csak az or t nem 
Limmit 3;
```
