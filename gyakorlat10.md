...
```js
hset auto rendzam xxx-111 tipus "SKoda Fabia" evjarat 2012 ertek 1500000
```
...
```js
rpush tantargyak "progamozás alapjai" matematika adatbaziskezeles
...
sadd bumbers2 15 30 45 60
SINTER numbers1 numbers2 // metszetet számol
```
